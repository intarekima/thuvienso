...
$(document).ready(function () {
    const $isFreeSelect = $('select[name="isFree"]');
    const $priceWrapper = $('#priceInputWrapper');
    const $priceInput = $('#price');

    function togglePriceField() {
        const isFree = $isFreeSelect.val() === "true";
        $priceWrapper.toggle(!isFree);
        $priceInput.prop('required', !isFree);
    }

    togglePriceField();
    $isFreeSelect.on('change', togglePriceField);
});
